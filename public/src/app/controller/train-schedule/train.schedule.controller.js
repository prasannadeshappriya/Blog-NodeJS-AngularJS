 ...
 */
angular.module('MyBlog').controller('TrainScheduleController',[
    '$scope', '$http', 'host_url',
    function($scope, $http, host_url){
        ...
        $scope.onInit = async function(){
            ...
            let response = await $http({
                ...
                url: host_url + 'update_statistics_trainwebapp'
            });
            if(response){
        ...
        $scope.search = async function () {
            ...
            try {
                ...
                $scope.isLoading = false;
                if (response) {
                    if(response.data.data.hasOwnProperty('connected')) {
